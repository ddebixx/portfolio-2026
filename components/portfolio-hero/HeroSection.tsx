...
export const HeroSection = async () => {
  ...
  return (
    <section className="grid grid-cols-1 col-span-2 gap-4 items-start justify-center">
      <h1 className="text-lg font-commit-mono-bold font-mono">
        <span className="terminal-prompt">$</span> 
        {author?.authors[0].name}
        <span className="terminal-cursor">_</span>
      </h1>
      <p className="text-sm font-commit-mono-regular text-muted-foreground">{author?.authors[0].authorDescription}</p>
